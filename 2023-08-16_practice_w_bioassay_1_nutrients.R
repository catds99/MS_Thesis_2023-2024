...
bioassay_1_NO3 = ggplot() +
  ...
  theme_classic() 
ggsave(bioassay_1_NO3, filename = "figures/bioassay_1_NO3.png",
...
bioassay_1_NO2 = ggplot() +
  ...
  scale_x_discrete(labels= c("T0" = "Time Zero", "Control" = "Control", "DIN" = "DIN", "LP" = "LP", "HP" = "HP", "DIN_LP" = "DIN + LP", "DIN_HP" = "DIN + HP")) +
  theme_classic() 
ggsave(bioassay_1_NO2, filename = "figures/bioassay_1_NO2.png",
       device = "png", height = 7, width = 11)
...
bioassay_1_NH4 = ggplot() +
  ...
  scale_x_discrete(labels= c("T0" = "Time Zero", "Control" = "Control", "DIN" = "DIN", "LP" = "LP", "HP" = "HP", "DIN_LP" = "DIN + LP", "DIN_HP" = "DIN + HP")) +
  theme_classic() 
ggsave(bioassay_1_NH4, filename = "figures/bioassay_1_NH4.png",
       device = "png", height = 7, width = 11)
...
bioassay_1_PO4 = ggplot() +
  ...
  scale_x_discrete(labels= c("T0" = "Time Zero", "Control" = "Control", "DIN" = "DIN", "LP" = "LP", "HP" = "HP", "DIN_LP" = "DIN + LP", "DIN_HP" = "DIN + HP")) +
  theme_classic() 
ggsave(bioassay_1_PO4, filename = "figures/bioassay_1_PO4.png",
       device = "png", height = 7, width = 11)